...
public class MapGenerator : MonoBehaviour
{
    ...
    void ProcessMap()
    {
        ...
        _contentGenerator.GenerateEntranceAndExit(survivingRooms,width,height,map);*/
        //StartCoroutine(_contentGenerator.MakeARandomObject(survivingRooms,width,height,map)) ;
    }
